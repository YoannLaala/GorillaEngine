...
namespace Gorilla { namespace Engine
{
	...
	void GeometryPass::Initialize(Renderer::RenderContext* _pContext)
	{
		...
		Renderer::Texture2D* pNormalTexture = _pContext->CreateTexture2D(RENDERER_TEXTURE_GEOMETRY_NORMAL, uiWidth, uiHeight, 1, Renderer::EFormat::R16G16B16A16_FLOAT, Renderer::EBind::RenderTarget | Renderer::EBind::ShaderResource);
