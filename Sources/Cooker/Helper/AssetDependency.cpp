...
//	//!	@brief		GetFormat
//	//!	@date		2015-11-22
//	Renderer::EFormat::Type GetTextureFormat(const DDSFile::PixelFormat& _kFormat)
//	{
//		// RGB
//		if(_kFormat.HasFlag(DDSFile::EFormat::RGB))
//		{
...
//		}
//		// Luminance
//		else if(_kFormat.HasFlag(DDSFile::EFormat::Luminance))
//		{
//			switch(_kFormat.GetRGBBitCount())
//			{
//				case 8:
...
//		}
//		// Alpha
//		else if(_kFormat.HasFlag(DDSFile::EFormat::Alpha))
//		{
...
//		}
//		// FourCC
//		else if(_kFormat.HasFlag(DDSFile::EFormat::FourCC))
//		{
//			// Check first value
...
//	//!	@brief		ConvertStream
//	//!	@date		2015-11-22
//	bool DDSFile::ConvertStream(FileReader& _kInputStream, FileWriter& _kOutputStream)
//	{
//		// Check header
...
//
//		// Generic Information
//		Renderer::EDimension::Type eDimension = Renderer::EDimension::Unknown;
...
//
//		// DXGI Format
//		Renderer::EFormat::Type eFormat = GetTextureFormat(kHeader.GetPixelFormat());
...
//			{
//				if((kHeader.GetWidth() > D3D11_REQ_TEXTURE3D_U_V_OR_W_DIMENSION) || (kHeader.GetHeight() > D3D11_REQ_TEXTURE3D_U_V_OR_W_DIMENSION) || (uiDepth > D3D11_REQ_TEXTURE3D_U_V_OR_W_DIMENSION) || (uiArrayCount > 1))
//				{
//					printf("[Texture] Texture3D Dimension not supported [W:%d][H:%d][D:%d][A:%d] (MAX [W:%d][H:%d][D:%d][A:%d])", kHeader.GetWidth(), kHeader.GetHeight(), uiArrayCount, D3D11_REQ_TEXTURE3D_U_V_OR_W_DIMENSION, D3D11_REQ_TEXTURE3D_U_V_OR_W_DIMENSION, D3D11_REQ_TEXTURE3D_U_V_OR_W_DIMENSION, 1);
//					return NULL;
//				}
//				break;
//			}
...
//				Renderer::TextureHelper::GetSurfaceInfo(uiWidth, uiHeight, eFormat, uiRowByte, uiSurfaceByte);
