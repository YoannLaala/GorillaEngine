#ifndef _COOKER_DDS_COOKER_HPP_
#define _COOKER_DDS_COOKER_HPP_
...
namespace Gorilla
{
	class DDSCooker : public AssetCooker
	{
	public:
		/******************************************************************************
		**	Flags
		...
		******************************************************************************/
		...
		bool			Serialize	(FileReader& _kInpuStream, FileWriter& _kOutputStream);
	};
}
#endif